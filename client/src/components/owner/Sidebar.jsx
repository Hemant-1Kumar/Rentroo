            ...
            <div className="flex md:flex-col md:gap-x-5 gap-y-8 md:mt-4">
              ...
              {navItems.map((link) => (
                <NavLink
                  ...
                  className={({isActive})=>
                  isActive 
                    ? "flexStart gap-x-2 p-5 lg:pl-12 text-sm font-bold sm:!text-sm cursor-pointer h-10 bg-primaryOne max-md:border-b-4 md:border-r-4 border-solid":"flexStart gap-x-2 lg:pl-12 p-5 text-sm font-bold sm:!text-sm cursor-pointer h-10 rounded-xl"}
