...
const Listing=()=> {
  ...
  // Search Filter using Headers's query
        ...
        <div className='flex flex-col sm:flex-row gap-6'> 
          ...
          <div className='min-w-72 bg-white p-4 pl-6 lg:pl-12 rounded-r-xl my-4'>
            ...
            <div className='py-3'>
              ...
              <select value={selectedSort} onChange={(e)=>setSelectedSort(e.target.value)} className='bg-primary ring-1 ring-slate-900/10
              outline-none text-gray-500 text-sm font-semibold
            ...
            <div className='p-5 mt-5 bg-primary rounded-xl' >
              <h5 className='mb-4'>Car Type</h5>
                {bodyType.map((type)=>(
                  <label key={type} className={"flex gap-2 text-sm font-semibold text-gray-500 mb-1"}>
            ...
            <div className=' p-5 mt-5 bg-primary rounded-xl'>
              <h5 className='mb-4'>Price Range</h5>
                {priceRange.map((price)=>(
                  <label key={price} className={"flex gap-2 text-sm font-semibold text-gray-500 mb-1"}>
          ...
          <div className='max-sm:px-10 sm:pr-10 bg-white p-4 rounded-l-xl my-4'>
            ...
            <div className='flexCenter flex flex-wrap mt-14 mb-10 gap-3'>
              ...
              {Array.from({length:totalPages},(_,index)=>(
                <button key={index+1}onClick={()=>setCurrPage(index+1)}className=
                {`btn-outline h-8 w-8 p-0 flexCenter
                  ${
