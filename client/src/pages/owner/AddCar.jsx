  ...
  overflow-y-scroll lg:w-11/12 bg-white shadow rounded-xl">
    ...
    font-medium xl:max-w-3xl">
      ...
      <div className="w-full">
        ...
        <textarea row={5} type="text" placeholder="Type here..."
        className="px-3 py-1.5 ring-1 ring-slate-900/10
        rounded-lg bg-primary mt-1 w-full"/>
      </div>
      ...
      <div className="flex gap-4 flex-wrap w-full">
        ...
        <div className="w-34">
          <h5>Odometer</h5>
          <input type="number" placeholder="e.g. 2,500(km)"
          className=" px-3 py-1.5 ring-1 ring-slate-900/10
          rounded-lg bg-primary mt-1 w-full"/>
        </div>
      </div>
        ...
        <div className="flex gap-3 flex-wrap mt-1">
          {Object.keys(inputs.features).map((feature,index)=>(
            <div key={index} className="flex gap-1">
              ...
              type="checkbox" checked={inputs.features[feature]} />
      ...
      <div className="flex gap-2 mt-2">
        {Object.keys(images).map((key)=>(
          ...
          className="ring-1 ring-slate-900/10 overflow-hidden rounded-lg">
            ...
            accept="image/*" id={`carImages${key}`}hidden/>
