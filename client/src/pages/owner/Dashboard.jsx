  ...
  return (
    <div className='md:px-8 py-6 xl:py-8 m-1 sm:m-3 h-[97vh] overflow-y-scroll lg:w-11/12 bg-white shadow rounded-xl'>
      ...
      <div className='grid grid-cols-2 gap-4'>
        ...
        <div className='flex items-center gap-7 p-5 bg-primaryOne lg:min-w-56 rounded-xl'>
      ...
      <div className='mt-4'>
        ...
        <div className='flex justify-between flex-wrap gap-2 sm:grid sm:grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-solid text-white border-b border-slate-900/10 rounded-t-xl'>
        ...
        <div>
          {dashboardData.bookings.map((booking, index) => (
            <div
              key={index}
              className='flex justify-between items-center flex-wrap gap-2 sm:grid sm:grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-primary text-gray-700 text-sm font-semibold border-b border-slate-900/10'
            >
              <div className='hidden lg:block'>
                {index + 1}
              </div>

              <div className='flex items-center gap-x-2 max-w-64'>
